# determine garch model parameter
...
spec2=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(1,2)),
                 mean.model=list(armaOrder=c(0,1),include.mean = TRUE),
                 distribution.model = "std",
                 fixed.pars = list(mu=0,omega=0))
g2i=ugarchfit(spec=spec2,data=log_rtn)

spec3=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(2,1)),
                  mean.model=list(armaOrder=c(0,1),include.mean = TRUE),
                  distribution.model = "std",
                  fixed.pars = list(mu=0,omega=0))
g3i=ugarchfit(spec=spec3,data=log_rtn)

spec4=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(2,2)),
                 mean.model=list(armaOrder=c(0,1),include.mean = TRUE),
                 distribution.model = "std",
                 fixed.pars = list(mu=0,omega=0))
...
spec5=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(1,1)),
                 ...
                 fixed.pars = list(mu=0,omega=0))
g5i=ugarchfit(spec=spec5,data=log_rtn)

spec6=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(1,2)),
                 mean.model=list(armaOrder=c(0,1),include.mean = TRUE),
                 distribution.model = "norm",
                 fixed.pars = list(mu=0,omega=0))
g6i=ugarchfit(spec=spec6,data=log_rtn)

spec7=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(2,1)),
                 mean.model=list(armaOrder=c(0,1),include.mean = TRUE),
                 distribution.model = "norm",
                 fixed.pars = list(mu=0,omega=0))
g7i=ugarchfit(spec=spec7,data=log_rtn)

spec8=ugarchspec(variance.model=list(model="iGARCH",garchOrder = c(2,2)),
                 mean.model=list(armaOrder=c(0,1),include.mean = TRUE),
                 distribution.model = "norm",
                 fixed.pars = list(mu=0,omega=0))
g8i=ugarchfit(spec=spec8,data=log_rtn)

ics = cbind(infocriteria(g1i),infocriteria(g2i),infocriteria(g3i),infocriteria(g4i),
            infocriteria(g5i),infocriteria(g6i),infocriteria(g7i),infocriteria(g8i))
